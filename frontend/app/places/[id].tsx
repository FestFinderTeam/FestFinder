							...
							{horarioAtencion.map((horario, index) => (
								<View
									...
									style={{
										...
										paddingVertical: 5,
										borderBottomWidth:
											index < horarioAtencion.length - 1 ? 1 : 0,
								...
								>
									...
									<Text
										style={{
											fontSize: 16,
											color: "#444",
											fontWeight: horario.horario ? "500" : "300",
										}}
									>
										{horario.horario
					...
					<>
						...
						>
							...
							<View style={{ top: "-20%", right: "40%" }}>
								<Link
									href={("https://wa.me/" + establecimiento.nro_ref) as Href}
								>
									<FontAwesome name="whatsapp" color={"green"} size={30} />
								</Link>
							</View>
						</View>
						...
						<FlatList
							...
							renderItem={({ item, index }) => (
								...
								>
									<Image
										source={
											item ? item : require("../../assets/images/default.jpg")
										}
										style={{
											width: "auto",
											height: 150,
