    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `${API_URL}/api/establecimiento/registro/`,
                {
                    method: "POST",
                    body: formData,
                }
            ...
            if (!response.ok) {
                ...
                throw new Error(
                    `Error al registrar el establecimiento: ${
                        response.statusText
                    } (${response.status}). Detalles: ${JSON.stringify(
                        errorDetails
                    )}`
                );
            }
        ...
        <ScrollView>
            ...
            >
                ...
                >
                    ...
                    <Pressable
                        style={[Styles.imageRoundedContainer, { left: "-30%" }]}
                        onPress={() => {
