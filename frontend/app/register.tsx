...
const Register = () => {
    ...
    const validateForm = () => {
        ...
        if (!emailRegex.test(email)) {
            errorMessages.email =
                "El email debe tener un formato válido: usuario@dominio.";
        }

        if (!/^\d{8}$/.test(telefono)) {
            errorMessages.telefono =
                "El teléfono debe tener solo números y 8 dígitos.";
        }
    ...
    if (loading) {
        return <LoadingScreen text="registrando usuario" />;
    }
            ...
            <View style={Styles.container}>
                ...
                <TextInput
                    ...
                    onChangeText={(e: string) =>
                        handleFieldChange(e, setName, "nombre")
                    }
                    onEndEditing={() =>
                        handleFieldChange(nombre, setName, "nombre")
                    }
                />
                {errors.nombre && (
                ...
                <TextInput
                    ...
                    style={Styles.input}
                    onChangeText={(e: string) =>
                        handleFieldChange(e, setEmail, "email")
                    }
                    onEndEditing={() =>
                        handleFieldChange(email, setEmail, "email")
                    }
                />
                {errors.email && (
                ...
                <TextInput
                    ...
                    style={Styles.input}
                    onChangeText={(e: string) =>
                        handleFieldChange(e, setTelephone, "telefono")
                    }
                    onEndEditing={() =>
                        handleFieldChange(telefono, setTelephone, "telefono")
                    }
                />
                {errors.telefono && (
                ...
                <View style={{ width: "80%" }}>
                    <View style={{ position: "relative" }}>
                        <TextInput
                            ...
                            onChangeText={(e: string) =>
                                handleFieldChange(e, setPassword, "p_field")
                            }
                            onEndEditing={() =>
                                handleFieldChange(
                                    p_field,
                ...
                {errors.general && (
                    <Text style={styles.errorText2}>{errors.general}</Text>
                )}
